    ...
    return (
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                ...
                >
                    {[
                        { value: '22,00M', label: 'USD Đầu tư', Icon: DollarSign, color: '#00E5FF' },
                        { value: '2', label: 'Trụ cột', Icon: Layers, color: '#E040FB' },
                        { value: '1 ha', label: 'KCNC HCM', Icon: MapPin, color: '#76FF03' },
                        { value: '130+', label: 'Việc làm', Icon: Users, color: '#FF9100' },
                    ].map((stat, i) => (
