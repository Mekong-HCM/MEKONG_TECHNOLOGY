...
const nextSteps = [
    { step: 1, label: 'Gui yeu cau thong tin', desc: 'Email invest@mekongtech.vn — nhan Investor Packet trong 24h', Icon: ClipboardList, color: '#00E5FF' },
    { step: 2, label: 'Hop trinh bay 1:1', desc: 'Trinh bay chi tiet + Q&A voi doi ngu dieu hanh', Icon: PhoneCall, color: '#E040FB' },
    { step: 3, label: 'Ky NDA & Due Diligence', desc: 'Truy cap mo hinh tai chinh day du, bao cao ky thuat', Icon: FileSignature, color: '#76FF03' },
    { step: 4, label: 'Term Sheet & Hop tac', desc: 'Thoa thuan dieu khoan — bat dau hanh trinh cung Mekong', Icon: Building2, color: '#FF9100' },
];

const trustSignals = [
    'Vi tri duoc BQL KCNC TP.HCM phe duyet',
    'Tu chu von 73,6% — khong phu thuoc ODA',
    'Mien thue TNDN 4 nam, giam 50% trong 9 nam tiep',
    'P(NPV>0) = 65% theo mo phong Monte Carlo',
];
            ...
            <div className="max-w-5xl mx-auto w-full relative z-10" ref={ref}>
                ...
                >
                    <GlassCard className="p-6 md:p-8">
                        <h3 className="text-lg font-bold text-white mb-6 text-center">Quy trinh Hop tac</h3>
                ...
                <div className="grid lg:grid-cols-2 gap-6 mb-8">
                    ...
                    >
                        <GlassCard className="p-6 h-full">
                            <h3 className="text-base font-bold text-white mb-4">Cong ty TNHH Mekong Technology</h3>
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    <MapPin size={16} className="text-neon-cyan flex-shrink-0 mt-0.5" />
                                    <div>
                                        <div className="text-sm font-semibold text-white">Dia chi Du an</div>
                                        <div className="text-xs text-gray-400 leading-relaxed">Lo E2-03, Duong D1, Khu Cong nghe Cao TP.HCM (SHTP)</div>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <Mail size={16} className="text-neon-cyan flex-shrink-0 mt-0.5" />
                                    <div>
                                        <div className="text-sm font-semibold text-white">Lien he</div>
                                        <div className="text-xs text-gray-400">invest@mekongtech.vn (Dau tu)</div>
                                        <div className="text-xs text-gray-400">partner@mekongtech.vn (Hop tac Ky thuat)</div>
                                    </div>
                                </div>
                            </div>
                        </GlassCard>
                    ...
                    >
                        <GlassCard className="p-6 h-full">
                            <h3 className="text-base font-bold text-white mb-4 flex items-center gap-2">
                                <ShieldCheck size={16} className="text-green-400" /> Diem Tin cay
                            </h3>
                ...
                >
                    <a href="mailto:invest@mekongtech.vn" className="btn-primary inline-flex items-center gap-2 text-lg px-10 py-4">
                        Gui yeu cau Investor Packet
                        <ArrowUpRight size={20} />
                    </a>
                    <p className="text-xs text-gray-500 mt-3">Phan hoi trong vong 24 gio lam viec</p>
                </motion.div>
