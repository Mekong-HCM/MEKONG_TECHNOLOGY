...
const revenueStreams = [
    { name: 'IoT Gateway (KX-200/300)', bu: 'Ngành 1', icon: Cpu, estimate: '2,5-3,5M/năm', margin: '50-65%', start: 'Y4', color: '#00E5FF' },
    { name: 'Robot AMR/AGV', bu: 'Ngành 1', icon: Cpu, estimate: '1,5-2,5M/năm', margin: '30-40%', start: 'Y4', color: '#4dd2ff' },
    { name: 'KinexusOS SaaS', bu: 'Ngành 1', icon: Cloud, estimate: '0,8-1,5M/năm', margin: '75-85%', start: 'Y4', color: '#E040FB' },
    { name: 'KinexusBMS/SCADA', bu: 'Ngành 1', icon: Cloud, estimate: '0,5-1,0M/năm', margin: '60-70%', start: 'Y5', color: '#b040db' },
    { name: 'OHT-100 (Semiconductor)', bu: 'Ngành 1', icon: Cpu, estimate: '0,5-1,0M/năm', margin: '35-45%', start: 'Y6', color: '#76FF03' },
    { name: 'CNC Outsource (FDI)', bu: 'CNC', icon: Cog, estimate: '2,0-3,0M/năm', margin: '38-45%', start: 'Y5', color: '#FF9100' },
    { name: 'CNC Custom Parts', bu: 'CNC', icon: Cog, estimate: '0,5-1,0M/năm', margin: '40-50%', start: 'Y5', color: '#f59e0b' },
    { name: 'Dịch vụ Kỹ thuật & Đào tạo', bu: 'Liên ngành', icon: Wrench, estimate: '0,3-0,5M/năm', margin: '50-60%', start: 'Y4', color: '#8b5cf6' },
    { name: 'Vận hành & Bảo trì', bu: 'Liên ngành', icon: GraduationCap, estimate: '0,2-0,5M/năm', margin: '55-65%', start: 'Y5', color: '#22c55e' },
];
        ...
        <div className="space-y-4">
            <GlassCard className="p-0 overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-dark-950/90 via-dark-950/50 to-transparent flex items-center px-5">
                    <div>
                        ...
                        <div className="text-xs text-neon-cyan">Ngành 1 + Ngành 2 — Steady state Y12+: 11,59M USD/năm</div>
                    </div>
                </div>
            </GlassCard>
            ...
            <div className="corporate-card p-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                        <div className="data-highlight-lg">11,59M</div>
            ...
            <div className="corporate-card p-5">
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <AreaChart data={financials.revenue15Y} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                        ...
                        />
                        <Area type="monotone" dataKey="nganh1" stackId="1" stroke="#00E5FF" fill="#00E5FF" fillOpacity={0.3} name="Ngành 1" />
                        <Area type="monotone" dataKey="nganh2" stackId="1" stroke="#E040FB" fill="#E040FB" fillOpacity={0.3} name="Ngành 2" />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
                ...
                <table className="w-full text-xs">
                    <thead>
                        <tr className="border-b border-corporate-slate/20">
                            ...
                            <th className="text-right py-2 text-neon-cyan">Ngành 1</th>
                            <th className="text-right py-2 text-pink-400">Ngành 2</th>
                    ...
                    <tbody>
                        {financials.revenue15Y.map((row, i) => (
                            <tr key={i} className="border-b border-white/5">
                                ...
                                <td className="text-right py-2 text-neon-cyan">{row.nganh1.toFixed(1)}</td>
                                <td className="text-right py-2 text-pink-400">{row.nganh2.toFixed(1)}</td>
            ...
            <div className="corporate-card p-5">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    {[
                        ...
                        { segment: 'DNNVV Sản xuất', approach: 'IoT/BMS bundle, KinexusOS SaaS', size: '83.035 DN toàn quốc' },
...
export function BusinessModel() {
    return (
        <TabSlide
            ...
            subtitle="9 nguồn doanh thu — Revenue steady 11,59M USD/năm (Y12+) — ~140M USD lũy kế 15 năm"
            tabs={tabs}
