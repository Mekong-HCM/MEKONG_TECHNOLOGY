        ...
        <SectionLayout id="production">
            <div ref={ref}>
                <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
                    <h2 className="section-title text-white">Năng lực <span className="gradient-text">Sản xuất CNC</span></h2>
                    <p className="section-subtitle">{totalMachines} máy CNC — {cncSpecs.designCapacity} — Tolerance {cncSpecs.tolerance}</p>
                </motion.div>
