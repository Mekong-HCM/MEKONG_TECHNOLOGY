...
```mermaid
graph TD
    BOD["Ban Quản trị — BOD<br/>5 thành viên"]
    CEO["Tổng Giám đốc — CEO<br/>Phạm Xuân Quốc"]
    CTO["Giám đốc Công nghệ — CTO<br/>Phạm Đình Chương"]
    CFO["Giám đốc Tài chính — CFO<br/>Phạm Thị Mỹ Phước"]
    COO["Giám đốc Vận hành — COO<br/>Bùi Thị Bích Thảo"]

    RD["Trung tâm R&D<br/>40–50 kỹ sư"]
    ...
    TC1["Trụ cột 1: IoT/Robot<br/>Tầng 1, Khối C — 80–100 người"]
    TC2["Trụ cột 2: CNC/MPMC<br/>Tầng 1, Khối B — 10–15 người"]
    TC3["Trụ cột 3: DC/MACC<br/>Tầng 2–3, Khối A — 30–40 người"]

    FIN["Kế toán, Tài chính, Pháp lý"]

    SX["Sản xuất, Chất lượng — QA/QC"]
    SC["Chuỗi cung ứng, Kho vận"]
...
flowchart LR
    subgraph IoT["IoT Gateway"]
        A1["Nhập linh kiện<br/>SMT Components"] --> A2["SMT Assembly<br/>Panasonic NPM-D3, 15K CPH"]
        A2 --> A3["AOI Inspection<br/>Omron VT-RNS"]
        A3 --> A4["ICT Testing<br/>Teradyne i3070"]
        A4 --> A5["Firmware<br/>Programming"]
        A5 --> A6["Burn-in Test<br/>8–24 giờ"]
        A6 --> A7["Final QC"]
    ...
    subgraph Robot["Robot Assembly"]
        B1["Chassis Manufacturing<br/>CNC Machining, Trụ cột 2"] --> B2["Electronics Assembly<br/>PCB + Sensors"]
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Phạm Xuân Quốc | CEO | Tiến sĩ IoT | 15 năm | IoT, Embedded Systems | Việt Nam |
| 2 | Phạm Đình Chương | CTO | Tiến sĩ Robotics | 12 năm | Robotics, AI/ML | Việt Nam |
...
| 7 | Dr. Hans Mueller | Technical Advisor | Tiến sĩ Robotics | 18 năm | Robot Navigation | Germany |
